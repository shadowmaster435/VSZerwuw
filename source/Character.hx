	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'zerwuw':
            				// ZERWUW ANIMATION LOADING CODE
            				tex = Paths.getSparrowAtlas('zerwuw','shared',true);
            				frames = tex;
            				animation.addByPrefix('idle', 'Zerwuw Idle Dance', 24, false);
            				animation.addByPrefix('singUP', 'Zerwuw UP', 24, false);
            				animation.addByPrefix('singRIGHT', 'Zerwuw RIGHT', 24, false);
            				animation.addByPrefix('singDOWN', 'Zerwuw DOWN', 24, false);
            				animation.addByPrefix('singLEFT', 'Zerwuw LEFT', 24, false);
